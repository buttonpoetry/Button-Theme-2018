...
/**
 * Logic to remove default store notice action and replace it in a custom location
 * The styles overriding the WooCommerce store notice are in _button-woocommerce.scss
 *
 * @since ButtonTheme 1.5.1
 */
remove_action( 'wp_footer', 'woocommerce_demo_store' );
add_action( 'bp_above_header', 'woocommerce_demo_store');
